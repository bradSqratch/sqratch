...
-- DropForeignKey
ALTER TABLE "Campaign" DROP CONSTRAINT "Campaign_communityId_fkey";

-- AlterTable
ALTER TABLE "Campaign" DROP COLUMN "communityId",
ADD COLUMN     "brandId" TEXT,
ADD COLUMN     "whyVideoSource" "CampaignVideoSource",
...
-- AlterTable
ALTER TABLE "User" DROP COLUMN "bettermodeMemberId";
...
CREATE TABLE "Brand" (
    ...
    "shopifyAdminAccessTokenEncrypted" TEXT,
...
-- CreateIndex
CREATE INDEX "CampaignUnlock_anonKey_campaignId_idx" ON "CampaignUnlock"("anonKey", "campaignId");
...
-- CreateIndex
CREATE INDEX "CampaignExperience_experienceId_sortOrder_idx" ON "CampaignExperience"("experienceId", "sortOrder");
...
-- CreateIndex
CREATE INDEX "Course_experienceId_isActive_sortOrder_createdAt_idx" ON "Course"("experienceId", "isActive", "sortOrder", "createdAt");

-- CreateIndex
CREATE INDEX "Course_experienceId_isActive_access_sortOrder_createdAt_idx" ON "Course"("experienceId", "isActive", "access", "sortOrder", "createdAt");

-- CreateIndex
CREATE INDEX "Lesson_courseId_idx" ON "Lesson"("courseId");

-- CreateIndex
CREATE INDEX "Lesson_courseId_isActive_sortOrder_createdAt_idx" ON "Lesson"("courseId", "isActive", "sortOrder", "createdAt");
...
-- CreateIndex
CREATE INDEX "Post_experienceId_isActive_idx" ON "Post"("experienceId", "isActive");
